...
| Core | Parent Issue | Responsibility | Keywords | Misroute examples |
| --- | --- | --- | --- | --- |
| `TSK-013-00-FIFTH-UIUX-FLOATING-CAPSULE-NAV` | [#466](https://github.com/STH-1-Class-One-Group/JamIssue/issues/466) | 5차 UI/UX 상단 헤더 제거 및 지도 플로팅 캡슐 내비게이션 | floating capsule; map nav; splash; notification; label icon | backend provider contract, DB schema, OAuth flow |

## TSK-013 Child Issues

| Child | Branch | 상태 | 완료/진행 근거 |
| --- | --- | --- | --- |
| [#467](https://github.com/STH-1-Class-One-Group/JamIssue/issues/467) | `fifth-uiux-audit-baseline` | 완료 | PR #473 |
| [#468](https://github.com/STH-1-Class-One-Group/JamIssue/issues/468) | `app-splash-entry-screen` | 완료 | PR #473 |
| [#469](https://github.com/STH-1-Class-One-Group/JamIssue/issues/469) | `map-floating-capsule-nav` | 완료 | PR #473 |
| [#470](https://github.com/STH-1-Class-One-Group/JamIssue/issues/470) | `map-header-subnav-removal` | 완료 | PR #473 |
| [#471](https://github.com/STH-1-Class-One-Group/JamIssue/issues/471) | `floating-nav-css-control-offsets` | 완료 | PR #473 |
