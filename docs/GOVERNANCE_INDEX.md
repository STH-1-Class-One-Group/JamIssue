...
| `TSK-010` | [#369](https://github.com/STH-1-Class-One-Group/JamIssue/issues/369) | Web Front service ownership, repository boundary, CI/deploy guardrails, and public/private repo responsibility split | child issue purpose branch | PR link, merge SHA, CI/deploy policy evidence, validation evidence |
...
| `TSK-027` | [#716](https://github.com/STH-1-Class-One-Group/JamIssue/issues/716) | My Page primary surface flattening and map search/location/FAB utility hierarchy hardening | child issue purpose branch | PR link, merge SHA, My Page surface evidence, map utility hierarchy evidence, CI link |
...
| `TSK-010-00-WEB-FRONT-SERVICE-OWNERSHIP-HARDENING` | [#369](https://github.com/STH-1-Class-One-Group/JamIssue/issues/369) | Web Front repository ownership, public/private responsibility split, CI/deploy guardrails, and service boundary hardening | repository ownership; ci; deploy; preview; production; public repo; private repo | UI/UX redesign, backend provider contract, DB schema, OAuth flow |
...
| `TSK-027-00-MY-PAGE-SURFACE-MAP-UTILITY-HIERARCHY` | [#716](https://github.com/STH-1-Class-One-Group/JamIssue/issues/716) | My Page primary page surface and scrollbar ownership plus map search/location/FAB hierarchy hardening | my page; surface; scrollbar; map search; current location; fab; hierarchy | backend provider contract, DB schema, OAuth flow, KTO provider contract, unrelated visual redesign |
