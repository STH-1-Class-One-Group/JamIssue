...
with seeded_places (slug, name, district, category, latitude, longitude, summary, description, vibe_tags, visit_time, route_hint, stamp_reward, hero_label, jam_color, accent_color, is_active) as (
  ...
  ('sindo-kalguksu', '신도칼국수', '동구', 'restaurant', 36.3320, 127.4348, '신도칼국수에서 대전 로컬 한 끼를 즐기기 좋은 인기 맛집입니다.', '신도칼국수은 대전에서 꾸준히 언급되는 로컬 맛집으로, 여행 동선에 한 끼를 자연스럽게 넣기 좋습니다.', '["로컬맛집","한끼","대전"]'::jsonb, '30분 - 1시간', '근처 카페나 산책 스폿과 함께 반나절 코스로 묶기 좋습니다.', '로컬 미식 스탬프', 'Local Bite', '#ff8d63', '#ffcf69', true),
  ('gongju-kalguksu', '공주칼국수', '서구', 'restaurant', 36.3248, 127.3820, '공주칼국수에서 대전 로컬 한 끼를 즐기기 좋은 인기 맛집입니다.', '공주칼국수은 대전에서 꾸준히 언급되는 로컬 맛집으로, 여행 동선에 한 끼를 자연스럽게 넣기 좋습니다.', '["로컬맛집","한끼","대전"]'::jsonb, '30분 - 1시간', '근처 카페나 산책 스폿과 함께 반나절 코스로 묶기 좋습니다.', '로컬 미식 스탬프', 'Local Bite', '#ff8d63', '#ffcf69', true),
