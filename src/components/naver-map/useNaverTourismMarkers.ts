...
export function useNaverTourismMarkers({
  ...
  useEffect(() => {
    ...
    // Bolt: Combine iterations to prevent O(N) memory allocations of intermediate arrays
    ...
    // Bolt: Build operations array directly using for...of loops to eliminate intermediate arrays and spread syntax
