...
export function useNaverTourismMarkers({
  ...
  useEffect(() => {
    ...
    // Bolt: Use single for...of loop to prevent O(N) intermediate array allocations during pan/zoom
    ...
    // Bolt: Prevent O(N) array mapping and spreading by using direct for...of loop construction
